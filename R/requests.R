...
#'
#' Requires a list of lists as an input. Tries to turn sublists into lists as well.
#'
...
#'
#' Meta includes count, next, previous, which are provided as top level "flat" values in the response json.
#'
#' @param x response list
